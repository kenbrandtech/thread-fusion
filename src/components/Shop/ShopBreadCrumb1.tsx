                        ...
                        <div className="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                            ...
                            <div className="list-tab flex flex-wrap items-center justify-center gap-y-5 gap-8 lg:mt-[70px] mt-12 overflow-hidden">
                                {["t-shirt", "dress", "top", "swimwear", "shirt"].map((item, index) => (
                                    <div key={index} className={`tab-item text-button-uppercase cursor-pointer has-line-before line-2px ${dataType === item ? "active" : ""}`} onClick={() => handleType(item)}>
                                        {item}
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="sidebar lg:w-1/4 md:w-1/3 w-full md:pr-12">
                            <div className="filter-type pb-8 border-b border-line">
                                ...
                                <div className="list-type mt-4">
                                    {["t-shirt", "dress", "top", "swimwear", "shirt", "underwear", "sets", "accessories"].map((item, index) => (
                                        <div key={index} className={`item flex items-center justify-between cursor-pointer ${dataType === item ? "active" : ""}`} onClick={() => handleType(item)}>
                            ...
                            <div className="filter-size pb-8 border-b border-line mt-8">
                                ...
                                <div className="list-size flex items-center flex-wrap gap-3 gap-y-4 mt-4">
                                    {["XS", "S", "M", "L", "XL", "2XL", "3XL"].map((item, index) => (
                                        <div key={index} className={`size-item text-button w-[44px] h-[44px] flex items-center justify-center rounded-full border border-line ${size === item ? "active" : ""}`} onClick={() => handleSize(item)}>
                                            {item}
                                        </div>
                                    ))}
                                    <div className={`size-item text-button px-4 py-2 flex items-center justify-center rounded-full border border-line ${size === "freesize" ? "active" : ""}`} onClick={() => handleSize("freesize")}>
                                        Freesize
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="filter-color pb-8 border-b border-line mt-8">
                                ...
                                <div className="list-color flex items-center flex-wrap gap-3 gap-y-4 mt-4">
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "pink" ? "active" : ""}`} onClick={() => handleColor("pink")}>
                                        <div className="color bg-[#F4C5BF] w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">pink</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "red" ? "active" : ""}`} onClick={() => handleColor("red")}>
                                        <div className="color bg-red w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">red</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "green" ? "active" : ""}`} onClick={() => handleColor("green")}>
                                        <div className="color bg-green w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">green</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "yellow" ? "active" : ""}`} onClick={() => handleColor("yellow")}>
                                        <div className="color bg-yellow w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">yellow</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "purple" ? "active" : ""}`} onClick={() => handleColor("purple")}>
                                        <div className="color bg-purple w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">purple</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "black" ? "active" : ""}`} onClick={() => handleColor("black")}>
                                        <div className="color bg-black w-5 h-5 rounded-full"></div>
                                        <div className="caption1 capitalize">black</div>
                                    </div>
                                    <div className={`color-item px-3 py-[5px] flex items-center justify-center gap-2 rounded-full border border-line ${color === "white" ? "active" : ""}`} onClick={() => handleColor("white")}>
